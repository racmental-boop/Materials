...
export const SidebarUpdateItem: FC<SidebarUpdateItemProps> = ({
  ...
  const fetchWorkpaceFunctions = {
    ...
    admin_messages: async () => {
      // Admin messages don't have workspace associations
      return []
    }
  }
  ...
  const updateFunctions = {
    ...
    admin_messages: async () => {
      // Admin messages cannot be updated through this interface
      throw new Error("Admin messages cannot be updated through this interface")
    }
  }
  ...
  const stateUpdateFunctions = {
    ...
    models: setModels,
    admin_messages: () => {
      // Admin messages state is handled separately
    }
  }
